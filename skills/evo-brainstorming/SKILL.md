...
1. **Explore project context** — check files, docs, recent commits
   - Read docs/constitution.md (understand constraints)
...
digraph brainstorming {
    ...
    "Invoke evo-writing-plans skill" [shape=doublecircle];
    ...
    "Write design doc" -> "Invoke evo-writing-plans skill";
}
```

**The terminal state is invoking evo-writing-plans.** Do NOT invoke frontend-design, mcp-builder, or any other implementation skill. The ONLY skill you invoke after brainstorming is evo-writing-plans.
