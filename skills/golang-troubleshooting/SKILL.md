...
description: >-
  Troubleshoot Golang programs systematically - find and fix the root cause. Use
  when encountering bugs, crashes, deadlocks, or unexpected behavior in Go code.
...
allowed-tools: >-
  ...
  Bash(dlv:*) Agent WebFetch WebSearch AskUserQuestion
---
