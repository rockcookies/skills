...
description: >-
  何时使用：生成或润色类型为：博客文章、技术文档、产品文案、周刊摘要、报告分析、知识教程等需要高质量中文输出的场景。
...
这份指南旨在指导大模型生成高质量、现代风格的简体中文内容。适用于博客、文档、评论、报告、周刊、营销文案、技术写作等多种场景。
...
- **开头**：遵循倒金字塔原则，1-2 句话点明核心内容
- **结尾**：简短总结或引导下一步行动，保持亲切感
...
| 场景 | 核心要求 | 注意事项 |
| --- | --- | --- |
| 博客/个人文章 | 观点鲜明，有个人风格 | 允许主观表达，但论据要扎实 |
| 技术文档 | 准确、结构化、可操作 | 步骤清晰，术语首次出现时解释 |
| 产品/营销文案 | 突出用户价值，简洁有力 | 用场景说话，避免空洞形容词 |
| 周刊/资讯摘要 | 信息密度高，快速扫描 | 每条 2-5 句，链接嵌入标题 |
| 报告/分析 | 数据驱动，逻辑严密 | 图表辅助，结论前置 |
| 知识分享/教程 | 循序渐进，示例丰富 | 从读者已知出发，逐步引入新概念 |
...
**链接嵌入**：将链接嵌入关键词，而不是裸露在文末。

- ✅ `[Tailwind CSS](url) 是一个实用优先的 CSS 框架，适合快速搭建页面。`
- ❌ `Tailwind CSS 是一个 CSS 框架。[原文链接]`
...
| 场景 | 优化前 | 优化后 | 原因 |
| --- | --- | --- | --- |
| 标题 | 一个非常好用的全新效率工具 | Raycast 发布 AI 扩展，支持本地模型调用 | 去冗余，突出核心 |
| 摘要 | 这篇文章介绍了一个工具，它可以帮助你做很多事情 | 一款开源的 Markdown 编辑器，支持实时预览和插件扩展 | 具体说明是什么 |
| 开头 | 大家好，今天我们来聊一个热门话题…… | 远程团队最头疼的问题不是时差，是信息断层。 | 直奔主题 |
| 引用 | 根据网上的消息，这个方案效果很好 | 据 ThoughtWorks 技术雷达 2025，平台工程已进入「采纳」阶段 | 具体来源 |
| 文案 | 我们的产品拥有强大而全面的功能 | 3 步完成部署，无需写一行配置文件 | 用场景替代形容词 |
